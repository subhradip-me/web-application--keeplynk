    ...
    <>
      ...
      <div className="h-[calc(100vh-4rem)] flex flex-col bg-white">
        ...
        <div className="bg-white border-b border-zinc-200 px-4 py-4 sticky top-0 z-10">
          ...
          {/* Search Bar */}
          <div className="flex items-center bg-zinc-100/70 border border-zinc-200 rounded-lg px-3 py-2.5">
        ...
        <div className="flex-1 overflow-y-auto px-4 py-4 custom-scrollbar bg-white">
          {loading ? (
            ...
            <div className="text-center py-20">
              <div className="w-20 h-20 mx-auto mb-5 rounded-2xl bg-blue-50 flex items-center justify-center">
                <Plus size={40} className="text-blue-600" strokeWidth={2} />
              </div>
            ...
            <div className="space-y-3">
              {filtered.map(resource => (
                <div
                  key={resource._id}
                  className="resource-card bg-white border border-zinc-200 rounded-xl p-4 hover:border-zinc-400 hover:shadow-md active:bg-zinc-50 relative transition-all"
                >
