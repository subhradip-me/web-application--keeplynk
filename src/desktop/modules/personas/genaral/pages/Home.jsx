...
export default function Home() {
  ...
  const handleViewFolders = () => {
    window.location.href = '/genaral/folders'
  }
  ...
  return (
    ...
    <div>
    <div className="p-8">
      <h1 className="text-3xl font-bold text-zinc-900 mb-4">General Hub</h1>
      <p className="text-zinc-600">General workspace content goes here.</p>
    </div>
    ...
    <div className="flex h-[85vh]">
      ...
      <div className='w-1/3 h-full bg-zinc-50 border-l border-zinc-200 p-6'>
        ...
        <div className="space-y-1">
          ...
          >
            <a href="/genaral/folders" className="flex items-center gap-3 w-full">
            <svg className="w-4 h-4 text-zinc-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
